...
def path_to_dict(path):
    """
    Generates dictionary from the path location which is used as tree.
    """
...
SAMPLE_TREE=[path_to_dict('/home/kolibri/Divya/Maharashtra2/Content-MH')]
...
class Upload(SushiChef):
    ...
    channel_info = {    #
        'CHANNEL_SOURCE_DOMAIN': 'Mh@xyz',       # who is providing the content (e.g. learningequality.org)
        'CHANNEL_SOURCE_ID':"MH123" ,                   # channel's unique id
        'CHANNEL_TITLE': "Maharastra-Topper",    # Master Toppr Videos BB
        'CHANNEL_LANGUAGE': 'en'
